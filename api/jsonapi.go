...
import (
	...
	wallet "github.com/projecthelixcoin/wallet-interface"
)
...
// ErrorResponse responds with an error code
...
// SanitizedResponseM sends a response using a proto message after cleaning up formatting
