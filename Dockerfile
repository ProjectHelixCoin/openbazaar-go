...
ENV PATH=$GOPATH/bin:$PATH
COPY . /go/src/github.com/projecthelixcoin/openbazaar-go
WORKDIR /go/src/github.com/projecthelixcoin/openbazaar-go
RUN go get -v github.com/projecthelixcoin/btcutil
RUN go get -v github.com/btcsuite/websocket
RUN go get -v github.com/projecthelixcoin/spvwallet
RUN go get -v github.com/projecthelixcoin/wallet-interface
